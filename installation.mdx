...
| `[chattts]` | `ChatTTS>=0.1.1` | Multilingual TTS with ChatTTS |
...
| `[whisper-mlx]` | `lightning-whisper-mlx>=0.0.10` | Lightning Whisper MLX for fast Whisper on Apple Silicon (macOS only) |
