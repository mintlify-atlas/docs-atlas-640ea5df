---
title: "Optimize Speech to Speech for Apple Silicon"
sidebarTitle: "Apple Silicon"
description: "Run the full pipeline natively on macOS using MLX-backed STT, LLM, and TTS for low-latency, GPU-accelerated voice conversations."
---
