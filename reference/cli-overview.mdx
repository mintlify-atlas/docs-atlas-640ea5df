---
title: "speech-to-speech CLI: Complete Command Reference"
...
Only fields that are explicitly declared in the corresponding argument dataclass are accepted as CLI flags. Refer to each backend's section in [STT Args](/reference/stt-arguments) or [LLM Args](/reference/llm-arguments) for the full list of supported `gen_*` parameters.
